...
<html>
	...
	<body>
		...
		<table class="wrapper">
			<tr>
				<td class="pole_content">
					...
					/* Content inner tag generated by this: 
					*	$APPLICATION->IncludeComponent("record:system.empty","radio_params",Array("CACHE_TYPE" => "A", "CACHE_TIME" => "86400",),false);
					<div class="station" itemscope itemtype="http://schema.org/BroadcastService" id="rr"><div class="station-img"></div><div class="station-text"><div itemprop="name" class="station-name">Radio Record</div><div class="station-track"></div></div><div class="hidden" itemprop="url">http://air.radiorecord.ru:8101/rr_320</div></div>
						...
						<div class="station" itemscope itemtype="http://schema.org/BroadcastService" id="teo"><div class="station-img"></div><div class="station-text"><div itemprop="name" class="station-name">Teodor Hardstyle</div><div class="station-track"></div></div><div class="hidden" itemprop="url">http://air.radiorecord.ru:8102/teo_320</div></div>
		...
		<div class="inner_pl">
			...
			<div class="pl_bot"><?
				/*	Content inner tag generated by this:
				*	$APPLICATION->IncludeComponent("record:system.empty","line_player_min",Array("CACHE_TYPE" => "A","CACHE_TIME" => "86400",),false);
				*	$APPLICATION->IncludeComponent("record:system.empty","nowtrack_min",Array("CACHE_TYPE" => "A","CACHE_TIME" => "86400",),false);
				*/?>
...
/*@@@*/				//if(radio!='rr' && bitrate == 'l128') { bitrate = 'l64'; $('.bitrate').children('div').removeClass('active'); $('.l64').addClass('active'); }
			...
			function update_track_inline() {	// функция обновления текущего трека
				$.getJSON('//www.radiorecord.ru/xml/'+radiof+'_online_v6.txt', function(data) {	// ссылка на файл с текущим треком
